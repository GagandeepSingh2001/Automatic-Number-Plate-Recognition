...
const About = () => {
  return (
    ...
    <div className="text order-2 lg:order-none">
      ...
      {/* Second Card */}
    <div className="text order-4 lg:order-none">
    ...
    <div className="flex flex-col md:flex-row justify-center m-10 gap-24 sm:gap-48">
