    ...
    return (
      ...
      <div className=''>
                        <div className="flex justify-around items-center">
                          ...
                          <h1 className='font-bold bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text lg:text-4xl md:text-3xl'>Detect with AI & YOLO test 4</h1>
