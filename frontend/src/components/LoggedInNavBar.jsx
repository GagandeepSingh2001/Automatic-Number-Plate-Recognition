...
const LoggedInNavBar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 backdrop-blur-lg border-b border-neutral-700/80">
        <div className="container px-4 mx-auto relative text-sm">
            <div className="flex justify-between items-center">
                ...
                <ul className="hidden lg:flex ml-32 space-x-12">
                    ...
                    <Link to="home" href="#home" spy={true} smooth={true} duration={500} offset={-80} activeClass="text-orange-400 border-b-2">
                        <li className="cursor-pointer hover:text-orange-400">Home</li>
                    </Link>
                    <Link to="features" href="#features" spy={true} smooth={true} duration={500} offset={-75} activeClass="text-orange-400 border-b-2">
                        <li className="cursor-pointer hover:text-orange-400">Features</li>
                    </Link>
                    <Link to="about" href="#about" spy={true} smooth={true} duration={500} offset={-75} activeClass="text-orange-400 border-b-2">
                        <li className="cursor-pointer hover:text-orange-400">About</li>
                    </Link>
                    <Link to="contact" href="#contact" spy={true} smooth={true} duration={500} offset={-75} activeClass="text-orange-400 border-b-2">
